...
from app.vendors.schemas import BankAccountSchema, ResolveBankAccountSchema

vendor_payment_router = APIRouter(prefix="/vendor", tags=["Vendor Payment Management"])
load_dotenv()
